...
public class Account {
    ...
    public Account(String accountId, String ownerName, BigDecimal balance) {
        if(accountId == null)
            ...
            throw new IllegalArgumentException("accountId can not be empty");
        if(ownerName == null)
            throw new IllegalArgumentException("ownerName can not be null");
        else if(ownerName.isBlank())
            throw new IllegalArgumentException("ownerName can not be empty");
        if(balance == null)
    ...
    public void withdraw(BigDecimal amount) {
        if(amount == null)
            ...
            throw new IllegalArgumentException("amount to be withdrawn can not be grater than balance");
